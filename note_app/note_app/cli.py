...
Usage ``note_app [OPTIONS] COMMAND [ARGS]...``

Example command 'welcome' has been added.
- To get your project version, run ``note_app --version``
- Run the sample command as ``note_app welcome [OPTIONS] NAME``
"""

from note_app import __version__
import click
...
def welcome(name, verbose):
    ...
    """
    click.secho(f"Hi {name}. Welcome to note_app", fg="cyan")
